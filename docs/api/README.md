...
* Functions: (4 total)
  ...
  * [`pynchon.annotate.module`](/src/pynchon/annotate.py#L93-L98) with signature `(name, module, working_dir=None) -> None`
  * [`pynchon.annotate.should_skip`](/src/pynchon/annotate.py#L101-L111) with signature `(name: str)`
-------------------------------------------------------------------------------
### pynchon.tagging
...
* Classes: (1 total)
  * [`pynchon.fleks.meta.namespace.Namespace`](/src/pynchon/fleks/meta/namespace.py#L1-L25)
    * with bases ([`__builtin__.object`](https://docs.python.org/3/library/functions.html#object),)
* Functions: (1 total)
  * [`pynchon.fleks.meta.namespace.namespace`](/src/pynchon/fleks/meta/namespace.py#L28-L36) with signature `(name, bases, namespace)`
-------------------------------------------------------------------------------
...
* Classes: (1 total)
  * [`pynchon.plugins.github.GitHub`](/src/pynchon/plugins/github.py#L15-L66)
    * with bases ([ToolPlugin](#pynchonmodelsplugin_types),)
    * with properties: (4 total)
...
* Classes: (2 total)
  * [`pynchon.plugins.python.cli.PythonCliConfig`](/src/pynchon/plugins/python/cli.py#L14-L56)
    * with bases ([Config](#pynchonabcsconfig),)
    * with properties: (2 total)
      *  [`entrypoints`](/src/pynchon/plugins/python/cli.py#L33) -> dict
      *  [`src_root`](/src/pynchon/plugins/python/cli.py#L20) -> inspect._empty
  * [`pynchon.plugins.python.cli.PythonCLI`](/src/pynchon/plugins/python/cli.py#L59-L249)
    * with bases ([ShyPlanner](#pynchonmodelsplanner),)
    * with properties: (5 total)
...
* Classes: (2 total)
  * [`pynchon.plugins.python.api.PythonApiConfig`](/src/pynchon/plugins/python/api.py#L9-L14)
    * with bases ([Config](#pynchonabcsconfig),)
  * [`pynchon.plugins.python.api.PythonAPI`](/src/pynchon/plugins/python/api.py#L17-L106)
    * with bases ([ShyPlanner](#pynchonmodelsplanner),)
    * with properties: (5 total)
...
* Functions: (2 total)
  * [`pynchon.util.text.normalize.normalize`](/src/pynchon/util/text/normalize/__init__.py#L17-L33)
    * with signature `(txt: str = '', post: List[Callable] = [<function <lambda> at 0x7fbc60652dc0>, <function <lambda> at 0x7fbc60652e50>], rules: List[Callable] = {' ': '_', '/': '_', '-': '_'}) -> str`
...
* Functions: (8 total)
  ...
  * [`pynchon.util.files.dumps`](/src/pynchon/util/files/__init__.py#L142-L149)
    * with signature `(content: str = None, file: str = None, quiet: bool = True, logger=<bound method Logger.info of <Logger pynchon.util.files (WARNING)>>)`
...
* Functions: (5 total)
  ...
  * [`pynchon.api.render.get_jinja_env`](/src/pynchon/api/render.py#L64-L90) with signature `(*includes, quiet: bool = False)`
  * [`pynchon.api.render.get_jinja_globals`](/src/pynchon/api/render.py#L29-L51) with signature `()`
  * [`pynchon.api.render.get_jinja_includes`](/src/pynchon/api/render.py#L57-L61) with signature `(*includes)`
  * [`pynchon.api.render.get_template`](/src/pynchon/api/render.py#L93-L106) with signature `(template_name: str, env=None)`
-------------------------------------------------------------------------------
### pynchon.api.pynchon
